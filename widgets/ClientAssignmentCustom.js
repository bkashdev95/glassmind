...
export default function ClientAssignmentCustom({ ...props }) {
	//DATA#
	const data = [
		{
			id: "1",
			title: "Assignment | Worksheets from CBT skills book",
			subtitle: "Please complete the following assignment.",
			action: "Completed | Ready for Review",
			status: "offline",
			type: "/img/svg/custom-flat.svg",
		},
		{
			id: "2",
			title: "Assignment | Emotion regulation worksheet",
			subtitle: "Review and complete the attached worksheet.",
			action: "Pending",
			status: "",
			type: "/img/svg/custom-flat.svg",
		},
		{
			id: "3",
			title: "Assignment | Beliefs and values workbook",
			subtitle: "Read this chapter and complete the questions at the end.",
			action: "Pending",
			status: "",
			type: "/img/svg/custom-flat.svg",
		},
	...
	return (
		<Card {...props}>
			<Card.Header>
				<h4 className='card-header-title'>Custom Assignments</h4>
